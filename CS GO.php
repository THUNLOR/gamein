  ...
  padding: 10px;
    ...
    <body>
      ...
      <br>
        ...
        <br>
        <br>
        <img class="smg" src="https://lh3.googleusercontent.com/proxy/YVOi9PDt6zixLz0BolLS0zdSZ8T-OF2pqUJb1VwjnfOLExWCHlL4yNNevW5c6Q3k9cjvV_-gVtDOrcALjJj7M6GYhuRs9zNfoDOB_FSwoPSXgrY3Jv2JksSTvd5GY6cBZHVRRXNEpA">
        <br>
        <br>
        <br>
        <br>
